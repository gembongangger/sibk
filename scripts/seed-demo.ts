...
const demoUsers: DemoUser[] = [
	...
	// Siswa
	{ username: 'ani_putri', password: 'siswa123', nama: 'Ani Putri Lestari', role: 'siswa', nis: '211001', kelas: 'X IPA 1', angkatan: 2024, email: 'ani.putri@student.sch.id' },
	{ username: 'bagas_prakoso', password: 'siswa123', nama: 'Bagas Prakoso', role: 'siswa', nis: '211002', kelas: 'X IPA 1', angkatan: 2024, email: 'bagas@student.sch.id' },
	{ username: 'citra_dewi', password: 'siswa123', nama: 'Citra Dewi Anggraini', role: 'siswa', nis: '212001', kelas: 'XI IPA 2', angkatan: 2023, email: 'citra.dewi@student.sch.id' },
	{ username: 'dimas_aryo', password: 'siswa123', nama: 'Dimas Aryo Nugroho', role: 'siswa', nis: '212002', kelas: 'XI IPS 1', angkatan: 2023, email: 'dimas.aryo@student.sch.id' },
	{ username: 'erlina_sari', password: 'siswa123', nama: 'Erlina Sari', role: 'siswa', nis: '213001', kelas: 'XII IPA 3', angkatan: 2022, email: 'erlina.sari@student.sch.id' }
];

const insert = db().prepare(
	`INSERT INTO users (username, password, nama, role, nis, kelas, angkatan, email)
	 VALUES (?, ?, ?, ?, ?, ?, ?, ?)
...
for (const u of demoUsers) {
	insert.run(u.username, hashPassword(u.password), u.nama, u.role, u.nis ?? null, u.kelas ?? null, u.angkatan ?? null, u.email ?? null);
	created++;
}
